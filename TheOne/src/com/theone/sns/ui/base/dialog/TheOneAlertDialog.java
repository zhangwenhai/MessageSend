...
public class TheOneAlertDialog extends Dialog implements DialogInterface {

	private TheOneAlertController mAlert;

	protected TheOneAlertDialog(Context context) {
		super(context);
		mAlert = new TheOneAlertController(context, this, getWindow());
	}

	protected TheOneAlertDialog(Context context, boolean cancelable,
	...
	public static class Builder {
		private final TheOneAlertController.AlertParams P;

		/**
		 * Constructor using a context for this builder and the
		 * {@link TheOneAlertDialog} it creates.
		 */
		public Builder(Context context) {
			P = new TheOneAlertController.AlertParams(context);
		}
		 ...
		 *         methods
		 */
		public Builder setPositiveButtonBg(int positiveButtonBgId) {
			P.mPositiveButtonBgId = positiveButtonBgId;
			return this;
		}
		 ...
		 *         methods
		 */
		public Builder setNegativeButtonBg(int negativeButtonBgId) {
			P.mNegativeButtonBgId = negativeButtonBgId;
			return this;
		}
		 ...
		 *         methods
		 */
		public Builder setNeutralButtonBg(int neutralButtonBgId) {
			P.mNeutralButtonBgId = neutralButtonBgId;
			return this;
		}
		 ...
		 *         methods
		 */
		public Builder setPnnButtonBg(int pnnBgId) {
			P.mPositiveButtonBgId = pnnBgId;
			P.mNegativeButtonBgId = pnnBgId;
			P.mNeutralButtonBgId = pnnBgId;
			return this;
		}
		...
		/**
		 * Creates a {@link TheOneAlertDialog} with the arguments supplied to
		 ...
		 */
		public TheOneAlertDialog create() {
			final TheOneAlertDialog dialog = new TheOneAlertDialog(P.mContext);
		 ...
		 */
		public TheOneAlertDialog show() {
			TheOneAlertDialog dialog = create();
			dialog.show();
			return dialog;
		}
		...
		/**
		 * @return the mCanceledOnTouchOutside
		 */
		 ...
		 *            the mCanceledOnTouchOutside to set
		 */
