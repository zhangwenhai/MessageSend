...
public class MultipartEntity extends AbstractHttpEntity {
	...
	static class Multipart {
		...
		private void doWriteTo(final OutputStream out,
		...
		private void writeStart(final OutputStream out,
				ByteArrayBuffer boundaryByte) throws IOException {
		...
		private void writeAllEnd(final OutputStream out,
				ByteArrayBuffer boundaryByte) throws IOException {
