...
public class RoundedImageView extends ImageView {
	...
	private static final ImageView.ScaleType[] sScaleTypeArray = { ImageView.ScaleType.MATRIX,
			ImageView.ScaleType.FIT_XY, ImageView.ScaleType.FIT_START,
	...
	public void setImageResource(int resId) {
		mDrawable = RoundedDrawable.fromDrawable(context.getResources().getDrawable(resId),
	...
	// super.loadCustLayoutImage(url, new CustLayoutHandler() {
	//
	// @Override
	// public void layout(Bitmap arg0) {
	// setImageBitmap(arg0);
	// RoundedImageView.this.setImageType(ImageViewEx.EImageType.EImageType_URL);
	// RoundedImageView.this.setTag(getTagKey(), url);
	// ImageViewEx.BitmapRefCache.Instance().get(url);
	// }
	// });
	// }
	//
	// @Override
	// public void loadImage(final String url, Drawable defaultBm) {
	// super.loadCustLayoutImage(url, null, new CustLayoutHandler() {
	//
	// @Override
	// public void layout(Bitmap arg0) {
	// setImageBitmap(arg0);
