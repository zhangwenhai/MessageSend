...
public class CircleFlowIndicator extends View implements FlowIndicator,
	...
	public CircleFlowIndicator(Context context, AttributeSet attrs) {
		...
		int activeDefaultColor = 0xFF727272;
		...
		int inactiveType = a.getInt(
				R.styleable.CircleFlowIndicator_inactiveType, STYLE_FILL);

		int inactiveDefaultColor = 0xFFb3b3b3;
		...
		// Retrieve the radius
		mRadius = a.getDimension(R.styleable.CircleFlowIndicator_radius1, 6.0f);
