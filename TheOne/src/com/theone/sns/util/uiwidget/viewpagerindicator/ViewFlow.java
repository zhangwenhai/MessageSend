 ...
 */
package com.theone.sns.util.uiwidget.viewpagerindicator;
...
/**
 * A horizontally scrollable {@link android.view.ViewGroup} with items populated
 * from an {@link android.widget.Adapter}. The ViewFlow uses a buffer to store
 * loaded {@link android.view.View}s in. The default size of the buffer is 3
 * elements on both sides of the currently visible {@link android.view.View},
 * making up a total buffer size of 3 * 2 + 1 = 7. The buffer size can be
 * changed using the {@code sidebuffer} xml attribute.
 *
 */
public class ViewFlow extends AdapterView<Adapter> {
	...
	/**
	 * Receives call backs when a new {@link android.view.View} has been
	 * scrolled to.
	 */
	public static interface ViewSwitchListener {
		 ...
		 *            {@link android.view.View} currently in focus.
		 */
	...
	/**
	 * Scroll to the {@link android.view.View} in the view buffer specified by
	 * the index.
	 *
	 * @param indexInBuffer
	...
	private void postViewSwitched(int direction) {
		...
		try {
			...
			if (mViewSwitchListener != null) {
				mViewSwitchListener.onSwitched(
