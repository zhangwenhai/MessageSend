...
/**
 * CameraPreview class that is extended only for the purpose of testing
 * CameraPreview class. This class is added functionality to set arbitrary
 * preview size, and removed automated retry function to start preview on
 * exception.
 */
public class ResizableCameraPreview extends CameraPreview {
    ...
    /**
     * @param activity
     * @param addReversedSizes is set to true to add reversed values of
     *                         supported preview-sizes to the list.
     */
    public ResizableCameraPreview(Activity activity, int cameraId, LayoutMode mode,
                                  boolean addReversedSizes) {
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
        ...
        try {
            ...
            Toast.makeText(mActivity, "Failed to start preview: " + e.getMessage(),
    ...
    /**
     * @param index  selects preview size from the list returned by
     *               CameraPreview.getSupportedPreivewSizes().
    ...
    public void setPreviewSize(int index, int width, int height) {
        ...
        Camera.Size pictureSize = determinePictureSize(previewSize);
        if (DEBUGGING) {
            Log.v(LOG_TAG, "Requested Preview Size - w: " + previewSize.width + ", h: "
                    + previewSize.height);
        }
        mPreviewSize = previewSize;
        mPictureSize = pictureSize;
