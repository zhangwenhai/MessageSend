...
package com.theone.sns.util.uiwidget.wheel;
...
import com.theone.sns.util.uiwidget.wheel.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	public void setCurrentItem(int index, boolean animated) {
		...
		viewAdapter.setCurrentIndex(index);// set current for refresh
		...
		if (index != currentItem) {
			if (animated) {
				...
				invalidateWheel(true);// no use cache
				invalidate();
			}
		}
	}
	...
	private void initResourcesIfNecessary() {
		...
		// }
		if (topShadow == null) {
			topShadow = getResources().getDrawable(R.drawable.rock_mask_top);
		}
		if (bottomShadow == null) {
			bottomShadow = getResources().getDrawable(
					R.drawable.rock_mask_bottom);
		}
	...
	/**
	 * Scroll the wheel items to scroll
	 *
	 * @param time
	 *            scrolling duration
	 */
